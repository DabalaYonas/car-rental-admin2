...
function UploadView(props) {
    ...
    return <div class="uploader" id="file-upload-form">
      <input id="file-upload" type="file" name="fileUpload" accept="image/*" onChange={fileSelectHandler} />

      <label for="file-upload" id="file-drag" onDragOver={fileDragHover} onDragLeave={fileDragHover} onDrag={fileSelectHandler}>
